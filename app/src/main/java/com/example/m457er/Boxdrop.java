...
class Boxdrop extends SurfaceView implements Runnable {
    ...
    public Boxdrop(Context context, int x, int y) {
...
// Reset the score and the player's chances
    ...
    private void draw() {
            ...
            if (mOurHolder.getSurface().isValid()) {
                ...
                mCanvas.drawRect(mBox.getRect(), mPaint);
